# File: optuna_tuning/objective_cs.py
import sys
import os
import optuna
import time
...
def train_cs(trial, fixed_env_args):
    ...
    params = {
        ...
        'pa': trial.suggest_float('pa', 0.1, 0.3),
    ...
    cs = CSOptimization(
        ...
        env=env.env,
        colony_size=params['population_size'],
        iterations=params['iterations'],
        pa=params['pa'],
        seed=42  # Add if your CS implementation supports seeding
    )
...
def objective(trial):
    ...
    return train_cs(trial, env_args)
