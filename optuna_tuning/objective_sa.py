# File: optuna_tuning/objective_sa.py
import sys
import os
import optuna
import time
...
def train_sa(trial, fixed_env_args):
    ...
    sa = SAOptimization(
        ...
        seed=42  # Add if your SA implementation supports seeding
    )
...
def objective(trial):
    ...
    return train_sa(trial, env_args)
