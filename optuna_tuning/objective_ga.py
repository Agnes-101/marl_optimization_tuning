# File: optuna_tuning/objective_ga.py
import sys
import os
import optuna
import time
...
def train_ga(trial, fixed_env_args):
    ...
    ga = GAOptimization(
        ...
        seed=42  # Add if your GA implementation supports seeding
    )
...
def objective(trial):
    ...
    return train_ga(trial, env_args)
