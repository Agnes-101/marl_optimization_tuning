# File: optuna_tuning/objective_de.py
import sys
import os
import optuna
import time
...
def train_de(trial, fixed_env_args):
    ...
    params = {
        ...
        'F': trial.suggest_float('F', 0.5, 1.0),
    ...
    de = DEOptimization(
        ...
        F=params['F'],
        CR=params['CR'],
        seed=42  # Add if your DE implementation supports seeding
    )
...
def objective(trial):
    ...
    return train_de(trial, env_args)
