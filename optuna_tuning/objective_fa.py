# File: optuna_tuning/objective_fa.py
import sys
import os
import optuna
import time
...
def train_fa(trial, fixed_env_args):
    ...
    fa = FireflyOptimization(
        ...
        beta0=params['beta0'],
        gamma=params['gamma'],
        seed=42  # Add if your FA implementation supports seeding
    )
...
def objective(trial):
    ...
    return train_fa(trial, env_args)
